...
VALUES (12,3,3,'20/01/2020','15:00','')
      ,(7,2,2,'06/01/2020','10:00','')
	  ,(8,2,3,'07/02/2020','11:00','')
	  ,(7,2,3,'06/02/2018','10:00','')
	  ,(9,1,2,'07/02/2019','11:00','')
	  ,(12,3,1,'08/03/2020','15:00','')
	  ,(9,1,1,'09/03/2020','11:00','');

UPDATE Pacientes SET IdUsuario = 5 WHERE IdPaciente = 7 ;
UPDATE Pacientes SET IdUsuario = 6 WHERE IdPaciente = 8 ;
UPDATE Pacientes SET IdUsuario = 7 WHERE IdPaciente = 9 ;
UPDATE Pacientes SET IdUsuario = 8 WHERE IdPaciente = 10 ;
UPDATE Pacientes SET IdUsuario = 9 WHERE IdPaciente = 11 ;
UPDATE Pacientes SET IdUsuario = 10 WHERE IdPaciente = 12 ;
